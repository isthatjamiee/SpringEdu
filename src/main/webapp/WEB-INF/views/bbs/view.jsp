...
<body>
<div class="container">
<p class="h3" align="center"> View Content </p>
<table class="table table-hover">
	<form:form action="" name="frm_1" id="myfrm1" method="post">
		...
		<tr>
			...
			<td scope="col" width="70%"><input type="text" name="bhit" readonly="readonly" class="form-control" id="" value="${view.bhit }" ></td>
		</tr>		
		<tr>
			<th scope="col" class="w-25 p-3">작성일</th>
			<td scope="col"><input type="text" name="cDate" readonly="readonly" class="form-control" id="" value="${view.bcdate }"></td>
		</tr>				
		<tr>
